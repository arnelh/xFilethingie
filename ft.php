...
$ft["settings"]["MAXSIZE"]           = 500000000; // Maximum file upload size - in bytes.
$ft["settings"]["PERMISSION"]        = 0644; // Permission for uploaded files.
$ft["settings"]["DIRPERMISSION"]     = 0755; // Permission for newly created folders.
...
$ft["settings"]["SHOWDATES"]         = "h:i:A d-M-Y"; // Set to a date format to display last modified date (e.g. 'Y-m-d'). See http://dk2.php.net/manual/en/function.date.php 
$ft["settings"]["FILEBLACKLIST"]     = "ft2php filethingiejs ftcss ft_configphp indexphp"; // Specific files that will not be shown.
...
$ft["settings"]["AUTOUPDATES"]       = "1"; // Number of days between checking for updates. Set to '0' to turn off.
...
$ft["plugins"]["edit"] = array(
 "settings" => array(
   "editlist" => "txt html xhtml htm php phtml htaccess css",
   "converttabs" => FALSE
 )
);
/*
